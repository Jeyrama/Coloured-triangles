...
You will be given the first row of the triangle as a string and it's your job to 
return the final colour which would appear in the bottom row as a string. 
In the case of the example above, if given RRGBRGBB, you should return G.

Note:
  The input string will only contain the uppercase letters R, G, B and 
